import SectionCopyright from "../organisms/SectionCopyright";
import ContainerFooterMenuSmall from "../organisms/ContainerFooterMenuSmall";
import FooterLinkList from "../organisms/FooterLinkList";
...
const Footer = () => {
  return (
    <footer className="flex flex-col lg:flex-row justify-center lg:justify-between w-full items-start px-5 pt-25 pb-10 lg:px-[80px] lg:py-25 bg-[#181A1C] text-white gap-[40px]">
